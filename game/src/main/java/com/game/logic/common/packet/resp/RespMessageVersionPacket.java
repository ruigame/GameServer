...
public class RespMessageVersionPacket extends ResponsePacket {
    /**
     * 服务器当前协议版本号
     */
    private String version;

    public static RespMessageVersionPacket create(String version) {
        RespMessageVersionPacket packet = PacketFactory.createPacket(PacketId.Base.RESP_VERSION);
